...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PopulationSize'
        db.create_table('popsize', (
            ...
            ('populationsize', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'core', ['PopulationSize'])


    def backwards(self, orm):
        # Deleting model 'PopulationSize'
        db.delete_table('popsize')
