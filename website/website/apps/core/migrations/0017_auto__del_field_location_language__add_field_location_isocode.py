...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('locations', 'language_id')

        # Adding field 'Location.isocode'
        db.add_column('locations', 'isocode',
                      self.gf('django.db.models.fields.CharField')(default='xxx', max_length=3, db_index=True),
                      keep_default=False)


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Location.language'
        raise RuntimeError("Cannot reverse this migration. 'Location.language' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Location.language'
        db.add_column('locations', 'language',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Language']),
                      keep_default=False)

        # Deleting field 'Location.isocode'
        db.delete_column('locations', 'isocode')
    ...
    models = {
        ...
        u'core.source': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'unique': 'True', 'max_length': '64'}),
            'year': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '12', 'null': 'True', 'blank': 'True'})
        }
    }
