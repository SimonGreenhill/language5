...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Source', fields ['author', 'year']
        db.delete_unique('sources', ['author', 'year'])

    def backwards(self, orm):
        # Adding unique constraint on 'Source', fields ['author', 'year']
        db.create_unique('sources', ['author', 'year'])
