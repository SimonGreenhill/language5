...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Language', fields ['dialect', 'isocode', 'language']
        db.create_unique('languages', ['dialect', 'isocode', 'language'])


    def backwards(self, orm):
        # Removing unique constraint on 'Language', fields ['dialect', 'isocode', 'language']
        db.delete_unique('languages', ['dialect', 'isocode', 'language'])
