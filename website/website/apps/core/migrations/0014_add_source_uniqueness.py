...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Source', fields ['year', 'author']
        db.create_unique('sources', ['year', 'author'])


    def backwards(self, orm):
        # Removing unique constraint on 'Source', fields ['year', 'author']
        db.delete_unique('sources', ['year', 'author'])
