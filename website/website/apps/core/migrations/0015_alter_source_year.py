...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'Source.year'
        db.alter_column('sources', 'year', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))

    def backwards(self, orm):
        # Changing field 'Source.year'
        db.alter_column('sources', 'year', self.gf('django.db.models.fields.IntegerField')(null=True))
