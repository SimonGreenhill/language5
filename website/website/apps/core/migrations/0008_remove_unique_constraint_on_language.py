...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Language', fields ['language']
        db.delete_unique('languages', ['language'])


    def backwards(self, orm):
        # Adding unique constraint on 'Language', fields ['language']
        db.create_unique('languages', ['language'])
