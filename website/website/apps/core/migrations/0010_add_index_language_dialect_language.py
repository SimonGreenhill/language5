...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Language', fields ['dialect', 'language']
        db.create_index('languages', ['dialect', 'language'])


    def backwards(self, orm):
        # Removing index on 'Language', fields ['dialect', 'language']
        db.delete_index('languages', ['dialect', 'language'])
