...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.records'
        db.add_column('tasks', 'records',
                      self.gf('django.db.models.fields.IntegerField')(default=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Task.records'
        db.delete_column('tasks', 'records')
