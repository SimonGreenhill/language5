...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Content.result'
        db.delete_column('entry_contents', 'result')

        # Deleting field 'Content.imported'
        db.delete_column('entry_contents', 'imported')


    def backwards(self, orm):
        # Adding field 'Content.result'
        db.add_column('entry_contents', 'result',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Content.imported'
        db.add_column('entry_contents', 'imported',
