...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field lexicon on 'Task'
        m2m_table_name = db.shorten_name('tasks_lexicon')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('task', models.ForeignKey(orm[u'entry.task'], null=False)),
            ('lexicon', models.ForeignKey(orm[u'lexicon.lexicon'], null=False))
        ))
        db.create_unique(m2m_table_name, ['task_id', 'lexicon_id'])


    def backwards(self, orm):
        # Removing M2M table for field lexicon on 'Task'
        db.delete_table(db.shorten_name('tasks_lexicon'))
