...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'WordlistMember', fields ['order']
        db.create_index('task_wordlists_members', ['order'])


    def backwards(self, orm):
        # Removing index on 'WordlistMember', fields ['order']
        db.delete_index('task_wordlists_members', ['order'])
