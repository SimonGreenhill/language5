...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('entry_tasks', (
            ...
            ('formname', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        ...
        # Adding model 'Result'
        db.create_table('entry_results', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('editor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('added', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entry.Task'])),
            ('content', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['entry.Content'])),
        ...
        db.send_create_signal('entry', ['Result'])
