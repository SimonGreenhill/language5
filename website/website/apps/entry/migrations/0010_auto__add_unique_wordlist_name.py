...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Wordlist', fields ['name']
        db.create_unique('task_wordlists', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Wordlist', fields ['name']
        db.delete_unique('task_wordlists', ['name'])
