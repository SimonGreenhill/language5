...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Task.completable'
        db.add_column('tasks', 'completable',
                      self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True),
                      keep_default=False)


        # Changing field 'Task.image'
        db.alter_column('tasks', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):
        # Deleting field 'Task.completable'
        db.delete_column('tasks', 'completable')


        # User chose to not deal with backwards NULL issues for 'Task.image'
        raise RuntimeError("Cannot reverse this migration. 'Task.image' and its values cannot be restored.")
