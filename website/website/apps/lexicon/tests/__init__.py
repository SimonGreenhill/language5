...
class DataMixin(object):
    ...
    def setUp(self):
        ...
        self.word2 = Word.objects.create(
            word='One', slug='one', full='1', editor=self.editor
        )
        self.word3 = Word.objects.create(
            word='Two', slug='two', full='2', editor=self.editor
        )
        ...
        self.subset_all = WordSubset.objects.create(
        ...
        self.subset_numbers = WordSubset.objects.create(
        ...
        self.subset_nothing = WordSubset.objects.create(
...
class DataMixinLexicon(DataMixin):
    def setUp(self):
        ...
        self.lexicon1 = Lexicon.objects.create(
            language=self.lang1,
            source=self.source1,
            word=self.word1,
            entry="A",
        ...
        self.lexicon2 = Lexicon.objects.create(
            language=self.lang2,
            source=self.source2,
            word=self.word2,
            entry="B",
        ...
        self.lexicon3 = Lexicon.objects.create(
            language=self.lang1,
            source=self.source1,
            word=self.word2,
            entry="C",
