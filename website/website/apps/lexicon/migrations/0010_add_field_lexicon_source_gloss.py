...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lexicon.source_gloss'
        db.add_column('lexicon', 'source_gloss',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lexicon.source_gloss'
        db.delete_column('lexicon', 'source_gloss')
    ...
    models = {
        ...
        u'lexicon.lexicon': {
            ...
            'source_gloss': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
