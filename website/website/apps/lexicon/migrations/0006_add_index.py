...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'CognateSet', fields ['protoform']
        db.create_index('cognatesets', ['protoform'])


    def backwards(self, orm):
        # Removing index on 'CognateSet', fields ['protoform']
        db.delete_index('cognatesets', ['protoform'])
