...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CognateSet.label'
        db.delete_column('cognatesets', 'label')

        # Adding field 'CognateSet.protoform'
        db.add_column('cognatesets', 'protoform',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)

        # Adding field 'CognateSet.gloss'
        db.add_column('cognatesets', 'gloss',
                      self.gf('django.db.models.fields.CharField')(max_length=128, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'CognateSet.label'
        db.add_column('cognatesets', 'label',
                      self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'CognateSet.protoform'
        db.delete_column('cognatesets', 'protoform')

        # Deleting field 'CognateSet.gloss'
        db.delete_column('cognatesets', 'gloss')
    ...
    models = {
        ...
        u'core.language': {
            'Meta': {'unique_together': "(('isocode', 'language', 'dialect'),)", 'object_name': 'Language', 'db_table': "'languages'"},
            'added': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'lexicon.cognateset': {
            ...
            'protoform': ('django.db.models.fields.CharField', [], {'max_length': '128', 'null': 'True', 'blank': 'True'}),
