...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Lexicon.entry'
        db.alter_column('lexicon', 'entry', self.gf('django.db.models.fields.CharField')(max_length=128))

        # Changing field 'Lexicon.phon_entry'
        db.alter_column('lexicon', 'phon_entry', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))

    def backwards(self, orm):

        # Changing field 'Lexicon.entry'
        db.alter_column('lexicon', 'entry', self.gf('django.db.models.fields.CharField')(max_length=32))

        # Changing field 'Lexicon.phon_entry'
        db.alter_column('lexicon', 'phon_entry', self.gf('django.db.models.fields.CharField')(max_length=32, null=True))
