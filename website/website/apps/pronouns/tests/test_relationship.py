...
class Test_get_pk_helper(RelationshipMixin, TestCase):
...
class Test_get_relationships_for_pronoun(RelationshipMixin, TestCase):
    """
    Test the function get_relationships_for_pronoun on the
    RelationshipManager for Relationship
    """
...
class Test_has_relationship_between(RelationshipMixin, TestCase):
    """
