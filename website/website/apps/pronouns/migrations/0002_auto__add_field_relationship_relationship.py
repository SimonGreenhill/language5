...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Relationship.relationship'
        db.add_column('pronoun_relationships', 'relationship',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=2, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Relationship.relationship'
        db.delete_column('pronoun_relationships', 'relationship')
    ...
    models = {
        ...
        u'pronouns.pronoun': {
            ...
            'comment': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'editor': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'gloss': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
