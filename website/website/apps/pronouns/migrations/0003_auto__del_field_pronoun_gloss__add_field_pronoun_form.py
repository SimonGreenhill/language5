...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Pronoun.gloss'
        db.delete_column('pronouns', 'gloss')

        # Adding field 'Pronoun.form'
        db.add_column('pronouns', 'form',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Pronoun.gloss'
        db.add_column('pronouns', 'gloss',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Pronoun.form'
        db.delete_column('pronouns', 'form')
